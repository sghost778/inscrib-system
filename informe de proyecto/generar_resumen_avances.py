...
add_para('5.2 Despliegue en Producción (Railway)', bold=True)
add_bullet('URL de producción: https://web-production-d4f80.up.railway.app')
add_bullet('Disponibilidad: 24/7 en la nube')
add_bullet('Interfaz de usuario modernizada y responsiva')
add_bullet('Panel administrativo y sitio web público accesibles')

add_para('5.3 Seguridad', bold=True)
...
add_para('5.4 PWA e Interfaz Modernizada', bold=True)
...
add_bullet('Interfaz responsiva adaptada a dispositivos móviles y de escritorio')
add_bullet('Mejoras visuales en la interfaz de usuario (UI modernizada)')
...
add_bullet('El sistema ya está desplegado en Railway con HTTPS (https://web-production-d4f80.up.railway.app).')
