...
semanas = [
    ...
    ('SEMANA N° 11 - (10 al 14 de Agosto 2026)', [
        ...
        ('Martes 11/08', 'Configuración del despliegue en Railway (https://web-production-d4f80.up.railway.app).'),
        ('Miércoles 12/08', 'Pruebas de funcionamiento en entorno de producción (Railway).'),
        ('Jueves 13/08', 'Modernización de la interfaz de usuario (UI responsiva y mejoras visuales).'),
        ('Viernes 14/08', 'Documentación de usuario, manuales y guía de acceso.'),
    ]),
    ('SEMANA N° 12 - (17 al 21 de Agosto 2026)', [
        ('Lunes 17/08', 'Revisión final del sistema. Ajustes menores en Railway.'),
        ('Martes 18/08', 'Elaboración del informe de pasantías.'),
        ('Miércoles 19/08', 'Continuación del informe. Inclusión de resultados y despliegue.'),
